...
const Chat: React.FC = () => {
  ...
  const fetchChatNames = async (profile: UserProfile | null) => {
    try {
      const response = await axios.get('https://upgrade.fineasapp.io:2053/get-chat-names', { params: { id_hash: profile?.id_hash } });
...
const checkCreditsAndSendMessage = async () => {
  ...
  try {
    const creditCheckResponse = await axios.post('https://upgrade.fineasapp.io:2053/enforce-credits', { id_hash: profile?.id_hash });
  ...
  const deleteChat = async (chatName: string) => {
    ...
    try {
      ...
      await axios.get('https://upgrade.fineasapp.io:2053/delete-chats', { params:{
  ...
  const saveChat = async () => {
    ...
    try {
      ...
      await axios.post('https://upgrade.fineasapp.io:2053/savechat', {
  ...
  const loadChat = async (name: string) => {
    ...
    try {
      ...
      const response = await axios.post('https://upgrade.fineasapp.io:2053/loadchat', {
