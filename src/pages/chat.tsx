  ...
  return (
    <div className="bg-main-color w-full h-screen overflow-hidden">
      ...
      <div className="flex h-full pt-2">
        ...
        <Card className="mt-[35px] glowing-border border shadow-xl w-[90%] max-w-[85%] bg-main-color overflow-hidden h-[100%] mb-24 text-white flex flex-col bg-opacity-75 z-10">
