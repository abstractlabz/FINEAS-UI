    ...
    >
      <div className="w-[980px] flex flex-row items-start justify-start gap-6 max-w-full mq1050:flex-wrap">
        ...
        <div className="flex-1 flex flex-col items-start justify-start relative max-w-full mq750:min-w-full">
          ...
          {/* Heading */}
          <h1 className="m-0 flex-1 relative text-inherit tracking-[0.02em] font-bold inline-block max-w-full z-[3] mq450:text-10xl mq750:text-19xl">
        ...
        <div className="flex flex-col items-start justify-start pt-6 px-0 pb-0 box-border max-w-full mq750:min-w-full mq1050:flex-1">
          <div className="self-stretch flex items-start justify-start relative max-w-full">
            {/* Background Gradient */}
            <div className="h-[654px] w-[654px] absolute top-[-232px] right-[-367px] rounded-full bg-gradient-to-b from-blue-500 via-transparent to-transparent opacity-25" />
            {/* Image */}
            <img
              className="w-[85%] h-auto max-w-full relative overflow-hidden object-cover shrink-0 z-[2] mx-auto"
              loading="lazy"
              alt=""
              src="/group-43@2x.png"
            />
